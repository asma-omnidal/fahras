...
// that sorts the posts
   ...
   for (var i=0; i < postTitle.length-1; i++) {
      for (var j=i+1; j<postTitle.length; j++) {
         ...
         if (sortBy == "التاريخ الأحدث") { if (postDate[i] < postDate[j]) { swapPosts(i,j); } }
      }
   }
} // end sortPosts
...
function showToc() {
  ...
  else { alert("الرجاء الانتظار، جاري التحميل ..."); }
}
